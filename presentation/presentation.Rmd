...
- Wagers et al (2009): retrieval is a two-step process
- Rechecking triggered by encountering agreement error on the verb
- Agreement attraction effect occurs when the attractor's activation level in memory is higher than the subject's
